...
export const ActionSheet: React.FC = () => {
  return (
    <ScrollView>
      <Spacer />
      <Button title={"Update Notification Metadata Randomly"} onPress={onUpdateNotificationMetadata} type={"primary"} />
      <Button title={"Update Current Track Metadata Randomly"} onPress={onUpdateCurrentTrackMetadata} type={"primary"} />
